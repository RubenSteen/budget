        ...
        <div class="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
            ...
            <section aria-labelledby="quick-links-title">
                ...
                <div class="sm:rounded-tr-lg relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500">
                    ...
                    <p class="mt-2 text-sm text-gray-500">The Laravel documentation is a great way to start, but if you do prefer video tutorials then there is no better place than Laracasts</p>
                    </div>
                    <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20 4h1a1 1 0 00-1-1v1zm-1 12a1 1 0 102 0h-2zM8 3a1 1 0 000 2V3zM3.293 19.293a1 1 0 101.414 1.414l-1.414-1.414zM19 4v12h2V4h-2zm1-1H8v2h12V3zm-.707.293l-16 16 1.414 1.414 16-16-1.414-1.414z" />
                ...
                <div class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Inertia is a piece of software that glues itself between Laravel and Vue and makes it way easier to make a Single Page Application (SPA) The best way to get a idea is watching a Laracast series about it.
                    </p>
                    </div>
                    <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500">
                    <div>
                    <span class="rounded-lg inline-flex p-3 ring-4 ring-white">
                        <svg class="h-6 w-6" viewBox="0 0 256 221" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                            <g>
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Vue.JS is one of many Javascript frameworks, it combines beatifully with InertiaJS and Laravel.
                    </p>
                    </div>
                    <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="rounded-bl-lg rounded-br-lg sm:rounded-bl-none relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Over 500+ professionally designed, fully responsive, expertly crafted component examples you can drop into your Tailwind projects and customize to your heart’s content. Get started by checking out our free preview components, or browsing all of the examples in the categories you're most curious about.</p>
                    </div>
                    <span class="pointer-events-none absolute top-6 right-6 text-gray-300 group-hover:text-gray-400" aria-hidden="true">
                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20 4h1a1 1 0 00-1-1v1zm-1 12a1 1 0 102 0h-2zM8 3a1 1 0 000 2V3zM3.293 19.293a1 1 0 101.414 1.414l-1.414-1.414zM19 4v12h2V4h-2zm1-1H8v2h12V3zm-.707.293l-16 16 1.414 1.414 16-16-1.414-1.414z" />
                ...
                <div class="p-6">
                    ...
                    <ul role="list" class="-my-5 divide-y divide-gray-200">
                        ...
                        <div class="relative">
                            ...
                            <p class="mt-1 text-sm text-gray-600 line-clamp-2">A fully working Authentication with <Link class="underline text-blue-500" :href="route('login')">Login</Link>, <Link class="underline text-blue-500" :href="route('register')">Register</Link> pages/methods</p>
                        </div>
                        </li>
                    ...
                    <ul v-if="users.length >= 1" role="list" class="-my-5 divide-y divide-gray-200">
                        ...
                        <li class="py-4" v-for="(user, index) in users" :key="index">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                <span v-show="user.admin" href="#" class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-cyan-400 text-sm leading-5 font-medium rounded-full text-white bg-cyan-500"> Admin </span>
                                </div>
                            </div>
                        </li>
