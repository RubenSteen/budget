		...
		<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
			<div class="relative flex flex-wrap items-center justify-center lg:justify-between">
				...
				<div class="hidden lg:ml-4 lg:flex lg:items-center lg:py-5 lg:pr-0.5">
					<!-- Profile dropdown -->
					<Menu v-if="$page.props.auth" as="div" class="ml-4 relative flex-shrink-0">
						<div>
					...
					<Link
						v-else
						:href="route('login')"
						class="order-1 ml-3 inline-flex items-center px-4 py-2 border border-cyan-100 shadow-sm text-sm font-medium rounded-md text-cyan-100 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-700 sm:order-0 sm:ml-0"
					>
						Sign in
					</Link>
				</div>
...
const navigation = [
	{ name: "Home", href: route("home"), current: true, auth: false, admin: false },
